    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-i-start-visiting-uc-berkeley-and-international-computer-science-institute-icsi-as-a-four-months-student-researcher-where-i-worked-in-professor-michael-mahoney-s-research-group-smile",
          title: 'I start visiting UC Berkeley and International Computer Science Institute (ICSI) as a...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=yacWa7IAAAAJ", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
